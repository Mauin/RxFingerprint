...
class FingerprintManagerRsaEncryptionObservable implements ObservableOnSubscribe<FingerprintEncryptionResult> {
    ...
    static Observable<FingerprintEncryptionResult> create(Context context, String keyName, char[] toEncrypt, boolean keyInvalidatedByBiometricEnrollment,
        ...
        try {
            return Observable.create(new FingerprintManagerRsaEncryptionObservable(new FingerprintApiWrapper(context, logger),
	...
	@VisibleForTesting
	FingerprintManagerRsaEncryptionObservable(FingerprintApiWrapper fingerprintApiWrapper,
