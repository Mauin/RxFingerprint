 ...
 */
class FingerprintDialogAuthenticationObservable extends FingerprintDialogObservable<FingerprintAuthenticationResult> {
	...
	@Nullable
	@Override
	protected FingerprintDialog.CryptoObject initCryptoObject(ObservableEmitter<FingerprintAuthenticationResult> subscriber) {
		// Simple authentication does not need CryptoObject
		return null;
	}

	@Override
	protected void onAuthenticationSucceeded(ObservableEmitter<FingerprintAuthenticationResult> emitter, FingerprintDialog.AuthenticationResult result) {
