...
class FingerprintManagerAesEncryptionObservable extends FingerprintManagerObservable<FingerprintEncryptionResult> {
	...
	/**
	 * Creates a new FingerprintManagerAesEncryptionObservable that will listen to fingerprint authentication
	 * to encrypt the given data.
	 *
	...
	static Observable<FingerprintEncryptionResult> create(Context context,
		...
		try {
			return Observable.create(new FingerprintManagerAesEncryptionObservable(new FingerprintApiWrapper(context, logger),
	...
	private FingerprintManagerAesEncryptionObservable(FingerprintApiWrapper fingerprintApiWrapper,
